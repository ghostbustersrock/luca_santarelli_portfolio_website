...
const experiences = [
  {
    ...
    overview: "AlliedOffsets is a carbon market intelligence platform providing data-driven insights to analysts, traders and ESG professionals across the global voluntary carbon market.",
    impact: "Owned and scaled the data infrastructure that powers the core product — ensuring reliable, up-to-date carbon market data from 15+ registries flows into production daily.",
    achievements: [
      "Built and maintained ETL pipelines scraping carbon credit data across 15+ global registries using Python, Selenium, and SQLAlchemy",
      "Led R&D into LLM-based scraping techniques, significantly reducing time spent on manual data extraction",
      "Designed and built RavenAI — an AI-powered Slack assistant built on a custom Claude MCP server, enabling the team to query meeting data and operational metrics in natural language",
      "Trained and mentored new developers joining the team, documenting systems and reviewing code",
      "Owned production reliability — debugging live incidents, managing deploys, and improving observability",
    ],
    tags: ["Python", "SQLAlchemy", "AWS", "Selenium", "Claude API", "MCP", "PostgreSQL"],
  ...
  },
  {
    ...
    impact: "Delivered backend systems and data pipelines that powered analytical workflows used by financial analysts and data teams at enterprise clients.",
    achievements: [
      "Designed and built backend APIs powering internal applications used daily by analysts across the financial industry",
      "Implemented an IHS Markit data integration, creating a reliable pipeline for financial market data",
    ...
    tags: ["Python", "FastAPI", "PostgreSQL", "React", "Docker", "AWS"],
  ...
  },
  {
    ...
    overview: "Hullabalook is a B2B e-commerce technology company providing visual merchandising and product discovery tools to major retail brands.",
    ...
    achievements: [
      "Developed full-stack features across the React frontend and Python/Flask backend",
  ...
  {
    role: "MSc Computer Science (Distinction) · BEng Electrical Engineering (First Class)",
    company: "Queen Mary University of London",
    period: "2016 — 2021",
    location: "London, UK",
    type: "Education",
    overview: "Queen Mary is a Russell Group university. The BEng in Electrical and Electronic Engineering provided a rigorous foundation in systems thinking, signal processing and mathematics. The MSc in Computer Science deepened expertise in algorithms, data structures and applied software systems.",
    ...
    tags: ["Swift", "iOS", "Algorithms", "Systems Design", "Signal Processing"],
